...
plt.plot(benchmark_stats["Processor nr"], benchmark_stats["mean"], label="Case 2", marker="o", linewidth = 4, color = 'blue')
...
plt.plot(parallel_stats["Processor nr"], parallel_stats["mean"], label="Case 3", marker="o", linewidth = 4, color = 'red')
