...
def configure_simulation(relaxationmcs, processor_nr, nx, ny, max_steps):
    ...
    metadata.ElementCC3D("NumberOfProcessors", {}, processor_nr)
...
configure_simulation(relaxationmcs, processor_nr, nx, ny, max_steps)    
