...
# Define the base directory and the structure of the folders
base_dir = r'.\ICCS_experiments\endothelialParameterScanBenchmark'
...
for index in range(40):
    ...
    file_path = os.path.join(base_dir, f'scan_iteration_{index}', 'combi_clean_benchmarked', 'datafiles', 'simulation_time.txt')
...
output_csv_path = os.path.join(base_dir, 'endothelial_simulation_data.csv')
